const allQuestions = [
    ...
    { "question": "웜델피(Warmdelpi) 종족은 어떤 특징을 가지고 있으며, 현재 개체 수가 줄어든 이유는 무엇인가?", "choices": ["지능이 낮아져서", "환경 오염으로 대부분 사망했기 때문", "물속에서 다른 종족에 의해 공격을 받았기 때문", "수렵 활동에 의한 과잉 포획"], "answer": 1 },
    ...
    { "question": "오리지널 웜델피는 어떤 존재였으며, 현재 웜델피들과의 차이점은 무엇인가?", "choices": ["고대의 신적 존재였으며, 현재는 개체 수가 줄어들었다.", "인간 형태였으며, 현재는 돌고래 형태로 진화했다.", "현재와 동일한 모습이지만, 지능이 낮아졌다.", "물속에서 왕국을 이끌던 존재였으며, 현재는 사라졌다."], "answer": 0 },
    ...
    { "question": "웜델피가 다시 번성하려면 어떤 조건이 필요할까?", "choices": ["온도가 다시 안정되어야 한다.", "새로운 개체가 태어날 수 있는 환경이 필요하다.", "다른 종족들이 웜델피와 협력해야 한다.", "오염된 바다가 회복되어야 한다."], "answer": 1 },
    ...
    { "question": "위리디스의 간빙기에서 어떤 특징이 나타날 것인가?", "choices": ["지구 온도가 급격히 낮아진다.", "바다의 수온이 상승하여 일부 생물이 적응한다.", "빙하가 전 세계로 퍼져 나가며 모든 것이 얼어버린다.", "간빙기에서는 바람이 불지 않게 된다."], "answer": 1 },
    { "question": "오사이운스에서 델피네가 발견한 해양 보물은 무엇이었을까?", "choices": ["고대 문명의 유물", "전설적인 해양 보석", "신비한 물고기 뼈", "오래된 동전과 보석"], "answer": 3 },
    ...
    { "question": "마레몰리스는 어떤 성격을 가진 캐릭터일까?", "choices": ["부드럽고 온화하며, 다른 이들을 도와주는 성격이다.", "차갑고 신중하지만, 지혜롭다.", "원래 야생적이었으나 이제는 사람들에게 친숙하다.", "감성적이고 직관적인 성격을 지닌다."], "answer": 2 },
    { "question": "글랜데스(Glandes)의 주요 특징은 무엇인가?", "choices": ["주로 야생에서 살아가며, 인간의 언어를 이해하지 못한다.", "조개였으나, 델피네와 피쉬가 입양한 반려패이다.", "고대 문명의 유물을 보관하고 있는 신비로운 존재이다.", "델피네와 함께 연구를 하고, 깊은 사고를 한다."], "answer": 1 },
    ...
    { "question": "위리디스의 대륙 이동은 어떻게 영향을 미쳤을까?", "choices": ["해양 생태계가 대규모로 변화했다.", "새로운 생물들이 출현했다.", "새로운 기후가 형성되었다.", "대륙 이동으로 지하 자원이 증가했다."], "answer": 0 },
    ...
    { "question": "알붐 우르시는 위리디스의 어느 환경에 거주하고 있는가?", "choices": ["북극", "사막", "산지", "바다"], "answer": 0 },
    { "question": "위리디스에서 간빙기 동안 가장 큰 영향을 받은 환경은 무엇인가?", "choices": ["산호와 바닷속 생물들이 대부분 죽었다.", "극지방에서 빙하가 녹아 대규모 홍수가 발생했다.", "따뜻한 바다에서의 다양한 생물들이 급격히 증가했다.", "지구 온도가 상승하면서 일부 종족들이 번성했다."], "answer": 2 },
    { "question": "델피네가 중요하게 생각하는 가치 중 하나는 무엇인가?", "choices": ["자유와 독립", "협력과 이해", "지식과 진리", "감성적 연결"], "answer": 2 },
    ...
    { "question": "위리디스에서 환경 변화에 대한 해결책으로 가장 중요한 것은 무엇인가?", "choices": ["기후 변화에 대한 국제적인 협력", "해양 생태계 복원을 위한 대규모 프로젝트", "새로운 생명체가 환경에 적응할 수 있도록 지원", "환경 오염을 줄이기 위한 기술 개발"], "answer": 1 },
    { "question": "알붐 우르시의 역할 중 중요한 부분은 무엇인가?", "choices": ["위리디스의 기후를 예측하는 역할", "자원을 관리하고 효율적으로 분배하는 역할", "다른 종족들에게 환경 문제 해결책을 제시하는 역할", "환경 문제에 대해 전략적으로 해결책을 제공하는 역할"], "answer": 3 },
    ...
    { "question": "위리디스 세계관에서 가장 중요한 환경적 특징은 무엇인가?", "choices": ["지속적인 지구온난화", "빙하기와 간빙기의 반복", "해양 생태계의 급격한 변화", "대륙 이동"], "answer": 1 },
    { "question": "빙하기와 간빙기의 순환 주기는 몇 년에 한 번씩 반복되는가?", "choices": ["1년", "5년", "10년", "1년마다 반복"], "answer": 0 },
    ...
    { "question": "웜델피(Warmdelpi) 종족은 어떤 특징을 가지고 있으며, 현재 개체 수가 줄어든 이유는 무엇인가?", "choices": ["이성적이고 지혜로운 종족, 환경 파괴와 기후 변화로 개체 수가 감소", "감정적이고 감각적인 종족, 폭력적인 전쟁으로 개체 수가 감소", "저돌적이고 사냥에 능한 종족, 자원 고갈로 개체 수가 감소", "의사소통 능력이 뛰어난 종족, 전염병과 자연 재해로 개체 수가 감소"], "answer": 0 },
    ...
    { "question": "글랜데스(Glandes)는 원래 어떤 존재였으며, 현재 델피네와 어떤 관계를 맺고 있는가?", "choices": ["조개였으며, 델피네의 반려패로 입양되었다.", "큰 돌고래였으며, 델피네의 스승이 되었다.", "작은 물고기였으며, 델피네의 친구가 되었다.", "조개였으며, 델피네의 연구 파트너로 함께 일을 한다."], "answer": 0 },
    ...
    { "question": "델피네가 가지고 있는 ‘고풍스러운 열쇠’는 어떤 의미를 가질 가능성이 높은가?", "choices": ["미스터리한 장소를 여는 열쇠", "과거의 고대 문명을 열쇠로 연결하는 단서", "보물 상자를 여는 열쇠", "중요한 지도나 정보를 열어주는 열쇠"], "answer": 0 },
    { "question": "오리지널 웜델피는 어떤 존재이며, 현재 웜델피들과의 차이점은 무엇인가?", "choices": ["고대의 웜델피로, 지능이 높고 독립적이었다.", "현대 웜델피보다 신체적 특성이 더 강했다.", "생태계 변화로 인해 웜델피는 거의 전멸되었고, 후손들만 존재한다.", "현재 웜델피는 매우 사회적이고 협력적인 성향을 띤다."], "answer": 0 },
    ...
    { "question": "웜델피가 다시 번성하려면 어떤 조건이 필요할까?", "choices": ["환경이 안정적이고 기후 변화가 완화되어야 한다.", "다른 종족과의 협력이 필수적이다.", "웜델피 종족 간의 강력한 사회적 규칙이 필요하다.", "기술 발전과 문명의 재건이 이루어져야 한다."], "answer": 0 },
    { "question": "위리디스의 기후 변화가 종족 간의 관계에 어떤 영향을 미칠 수 있는가?", "choices": ["기후 변화로 인해 종족 간의 경쟁이 심화될 수 있다.", "기후 변화로 종족 간 협력이 강해질 것이다.", "기후 변화로 새로운 종족이 등장할 것이다.", "기후 변화가 종족 간의 대립을 막고 평화를 가져올 것이다."], "answer": 0 },
    { "question": "네가 위리디스 세계관에서 한 종족의 지도자가 된다면, 환경 문제를 해결하기 위해 어떤 정책을 시행할 것인가?", "choices": ["자원의 효율적인 사용과 재활용을 강조하고, 지속 가능한 에너지 개발에 집중한다.", "모든 종족이 한 지역으로 이주하도록 하여 환경 문제를 해결한다.", "기후 변화에 적응할 수 있는 유전자 조작을 통해 종족의 생존을 보장한다.", "자연의 법칙을 존중하며 전통적인 방법으로 환경을 복원한다."], "answer": 0 },
];
